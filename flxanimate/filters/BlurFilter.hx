...
@:final class BlurFilter extends BitmapFilter // reinvent the blur to be more performant?
{
	...
	**/
	...
	@:noCompletion private override function __initShader(renderer:DisplayObjectRenderer, pass:Int, sourceBitmapData:BitmapData):Shader
	{
		...
		var rend = cast(renderer, OpenGLRenderer);


		if (pass >= __numShaderPasses - 1)
		{
			// rend.__context3D.setScissorRectangle(null);
		...
		if (pass < __horizontalPasses)
		{
			...
			__blurShader.uRadius.value[0] = __blurX * scale;
		...
		else
		{
			...
			__blurShader.uRadius.value[1] = __blurY * scale;
		}
		#end
